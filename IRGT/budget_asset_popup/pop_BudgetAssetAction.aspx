<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/popup.master" AutoEventWireup="true" CodeFile="pop_BudgetAssetAction.aspx.cs" Inherits="budget_popup_pop_BudgetAssetAction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:600px" ng-app="myApp" ng-controller="fnMain">
        ...
        <tr><td colspan="4" style="height:10px"></td></tr>
        <tr>
            <td><%=Session["budget_asset_Column031"] %></td>
            <td colspan="3">
        ...
        <tr><td colspan="4" style="height:10px"></td></tr>
        <tr>
            <td><%=Session["budget_asset_Column041"] %></td>
            <td colspan="3">
