...
public partial class budget_BudgetAssetByIDAction : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string PageFunction = "budget_asset";
        ...
        string BA_ID = Request.QueryString["BA_ID"];
        Session["BA_ID"] = BA_ID;
        ...
        if (LANG == cCommon.Language_Thai)
        {
            ...
            Session["pop_confirms_" + PageFunction] = "คุณแน่ใจหรือไม่ที่จะยืนยันการตรวจสอบข้อมูล " + PageName + " : " + BA_ID + " นี้ ?";
            Session["pop_approve_" + PageFunction] = "คุณแน่ใจหรือไม่ที่จะอนุมัติข้อมูล " + PageName + " : " + BA_ID + " นี้ ?";
            ...
            //================ TABLE ==================================================
            Session["HeaderText"] = PageName + " : " + BA_ID;
