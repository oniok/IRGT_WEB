<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="BudgetAssetListAction.aspx.cs" Inherits="budget_BudgetAssetListAction" %>
                                        ...
                                        <center>
                                            <table>
                                                <tr>                                                    
                                                    ...
                                                    <td><%=Session["budget_asset_list_Column01"]%></td>
                                                    <td style="width:5px"></td>                                                   
                                                    <td>
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
														        <th class="center" style="width:50px"><%=Session["budget_asset_list_ColumnSEQ"]%></th>
                                                                <th class="center"><%=Session["budget_asset_list_Column00"]%></th>
														        <th class="center"><%=Session["budget_asset_list_Column01"]%></th>
														        <th class="center" style="width:100px"><%=Session["budget_asset_list_Column02"]%></th>
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["budget_asset_list_Column03"]%>
                                                                </th>
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["budget_asset_list_Column04"]%>
                                                                </th>   
                                                                <th class="center" style="width:200px"><%=Session["budget_asset_list_Column05"]%></th>
														        <td class="center" style="width:80px"><%=Session["budget_asset_list_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
													        <tr ng-repeat="x in Data">
														        <td class="center">{{ x.RowID }}</td>
                                                                <td class="center">{{ x.BA_ID }}</td>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnDetail = function (BA_ID) {           
            ...
            window.open(
              "../budget_asset/BudgetAssetByIDAction.aspx?BA_ID=" + BA_ID+"&lang="+lang,
              "_blank"
            );
        }
