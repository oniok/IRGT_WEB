<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="BudgetPositionListAction.aspx.cs" Inherits="budget_BudgetPositionListAction" %>
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
                                                                ...
                                                                <th class="center" style="width:200px"><%=Session["budget_position_list_Column05"]%></th>
														        <td class="center" style="width:80px"><%=Session["budget_position_list_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnDetail = function (BP_ID) {           
            ...
            window.open(
              "../budget_position/BudgetpositionByIDAction.aspx?BP_ID=" + BP_ID+"&lang="+lang,
              "_blank"
            );
        }
