...
public partial class budget_BudgetProjectByIDAction : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string BR_ID = Request.QueryString["BR_ID"];
        Session["BR_ID"] = BR_ID;
        ...
        if (LANG == cCommon.Language_Thai)
        {
            ...
            Session["pop_confirms_" + PageFunction] = "คุณแน่ใจหรือไม่ที่จะยืนยันการตรวจสอบข้อมูล " + PageName + " : " + BR_ID + " นี้ ?";
            Session["pop_approve_" + PageFunction] = "คุณแน่ใจหรือไม่ที่จะอนุมัติข้อมูล " + PageName + " : " + BR_ID + " นี้ ?";
            ...
            //================ TABLE ==================================================
            Session["HeaderText"] = PageName + " : " + BR_ID;
