...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_budget_project"]%>', "../budget_project_popup/pop_BudgetProject.aspx", null, "450");
        }
        ...
        $scope.fnDelete = function (KeyID) {
            tmpKeyID = KeyID;
            fnConfirmMessage('<%=Session["pop_confirm_budget_project"]%>', '<%=Session["pop_delete_budget_project"]%>', fnDeleteYes);
        }
