<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="BudgetProjectList.aspx.cs" Inherits="budget_BudgetProjectList" %>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnDetail = function (BR_ID) {           
            ...
            window.open(
              "../Budget_Project/BudgetOperationByID.aspx?BR_ID=" + BR_ID + "&lang=" + lang,
              "_blank"
            );
        }
