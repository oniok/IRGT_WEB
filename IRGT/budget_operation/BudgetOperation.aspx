...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_budget_operation"]%>', "../budget_operation_popup/pop_BudgetOperation.aspx", null, "450");
        }
        $scope.fnEdit = function (KeyID) {           
            fnOpenPopup('<%=Session["pop_edit_budget_operation"]%>', "../budget_operation_popup/pop_BudgetOperation.aspx?KeyID=" + KeyID, null, "450");
        }
