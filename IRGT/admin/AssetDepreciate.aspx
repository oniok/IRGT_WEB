<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="AssetDepreciate.aspx.cs" Inherits="admin_AssetDepreciate" %>
                                        ...
                                        <center>
                                            <table>
                                                <tr>                                                    
                                                    ...
                                                    <td><%=Session["asset_depreciate_Column02"]%></td>
                                                    <td style="width:5px"></td>                                                   
                                                    <td>
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
														        <th class="center" style="width:50px"><%=Session["asset_depreciate_ColumnSEQ"]%></th>
														        <th class="center" style="width:100px"><%=Session["asset_depreciate_Column01"]%></th>
														        <th class="center"><%=Session["asset_depreciate_Column02"]%></th>
                                                                <th class="center"><%=Session["asset_depreciate_Column03"]%></th>          
                                                                <th class="center"><%=Session["asset_depreciate_Column06"]%></th>    
                                                                <th class="center"><%=Session["asset_depreciate_Column07"]%></th>                                                                
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["asset_depreciate_Column04"]%>
                                                                </th>
                                                                <th class="center" style="width:100px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["asset_depreciate_Column05"]%>
                                                                </th>														      
														       <td class="center" style="width:80px"><%=Session["asset_depreciate_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
													        <tr ng-repeat="x in Data">
                                                                ...
                                                                <td>{{ x.Asset_ID }}</td>
                                                                <td>{{ x.Asset_Name }}</td>
                                                                <td>{{ x.Depreciate_Rate }}</td>          
                                                                <td>{{ x.Standard_Price }}</td>														                                                            
                                                                <td>{{ x.Term_Use }}</td>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_asset_depreciate"]%>', "../admin_popup/pop_AssetDepreciate.aspx", null, "450");
        }
        $scope.fnEdit = function (KeyID) {           
            fnOpenPopup('<%=Session["pop_edit_asset_depreciate"]%>', "../admin_popup/pop_AssetDepreciate.aspx?KeyID=" + KeyID, null, "450");
        }
        $scope.fnDelete = function (KeyID) {
            tmpKeyID = KeyID;
            fnConfirmMessage('<%=Session["pop_confirm_asset_depreciate"]%>', '<%=Session["pop_delete_asset_depreciate"]%>', fnDeleteYes);
        }
