<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="WorkCenter.aspx.cs" Inherits="admin_WorkCenter" %>
                        ...
                        <div class="row">
									<div class="col-xs-12">
                                        ...
                                        <center>
                                            <table>
                                                <tr>
                                                    <td><%=Session["work_center_Column01"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Loc_ID" style="width:100px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td><%=Session["work_center_Column02"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Loc_Name_T" style="width:150px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td><%=Session["work_center_Column03"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Loc_Name_E" style="width:150px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td>         
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
														        <th class="center" style="width:50px"><%=Session["work_center_ColumnSEQ"]%></th>
														        <th class="center" style="width:100px"><%=Session["work_center_Column01"]%></th>
														        <th class="center"><%=Session["work_center_Column02"]%></th>
                                                                <th class="center"><%=Session["work_center_Column03"]%></th>
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["work_center_Column04"]%>
                                                                </th>
                                                                <th class="center" style="width:100px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["work_center_Column05"]%>
                                                                </th>														      
														       <td class="center" style="width:80px"><%=Session["work_center_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_work_center"]%>', "../admin_popup/pop_WorkCenter.aspx", null, "450");
        }
        $scope.fnEdit = function (KeyID) {
            fnOpenPopup('<%=Session["pop_edit_work_center"]%>', "../admin_popup/pop_WorkCenter.aspx?KeyID=" + KeyID, null, "450");
        }
        $scope.fnDelete = function (KeyID) {
            tmpKeyID = KeyID;
            fnConfirmMessage('<%=Session["pop_confirm_work_center"]%>', '<%=Session["pop_delete_work_center"]%>', fnDeleteYes);
        }        
    ...
    function GetPaging($scope, $http) {
        ...
        var Loc_Name_T = document.getElementById('Loc_Name_T').value;
        var Loc_Name_E = document.getElementById('Loc_Name_E').value;
