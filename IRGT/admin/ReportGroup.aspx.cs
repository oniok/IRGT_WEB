...
public partial class admin_ReportGroup : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string PageFunction = "report_group";
        ...
        if (LANG == cCommon.Language_Thai)
        {
            ...
            //================ POPUP ERROR ===========================================
            Session[PageFunction + "_ERROR_01"] = "โปรดระบุ ประเภทรายงาน";
            Session[PageFunction + "_ERROR_02"] = "โปรดระบุ หน่วยงาน";
            ...
            Session[PageFunction + "_Column01"] = "ประเภทรายงาน";
        ...
        else
        {
            ...
            //================ POPUP ERROR ===========================================
            Session[PageFunction + "_ERROR_01"] = "Please specify Report Group Type";
            ...
            Session[PageFunction + "_ColumnEdit"] = "";
            Session[PageFunction + "_Column01"] = "Report Group Type";
