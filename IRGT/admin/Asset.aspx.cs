...
public partial class admin_Asset : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (LANG == cCommon.Language_Thai)
        {
            ...
            Session[PageFunction + "_ERROR_02"] = "โปรดระบุ ชื่อ" + PageName + "(ไทย) 1";
            Session[PageFunction + "_ERROR_03"] = "โปรดระบุ ชื่อ" + PageName + "(อังกฤษ) 1";
            ...
            Session[PageFunction + "_ERROR_07"] = "โปรดเลือกประเภทครุภัณฑ์";
            //================ TABLE ==================================================
            ...
            Session[PageFunction + "_Column02"] = "ชื่อ" + PageName + "(ไทย) 1";
            Session[PageFunction + "_Column03"] = "ชื่อ" + PageName + "(อังกฤษ) 1";
            Session[PageFunction + "_Column04"] = "วันที่เริ่มใช้งาน";
            Session[PageFunction + "_Column05"] = "วันที่สิ้นสุด";
            Session[PageFunction + "_Column06"] = "ประเภทครุภัณฑ์";

            Session[PageFunction + "_Column07"] = "ชื่อ" + PageName + "(ไทย) 2";
            Session[PageFunction + "_Column08"] = "ชื่อ" + PageName + "(อังกฤษ) 2";
            Session[PageFunction + "_Column09"] = "หน่วยเรียก";
            Session[PageFunction + "_Column10"] = "รหัสครุภัณฑ์อ้างอิง";
        }
        else
        {
            //================ POPUP ==================================================
            string PageName = "Asset";
            ...
            //================ POPUP ERROR ===========================================
            Session[PageFunction + "_ERROR_01"] = "Please specify Asset ID";
            Session[PageFunction + "_ERROR_02"] = "Please specify Asset Name Thai 1";
            Session[PageFunction + "_ERROR_03"] = "Please specify Asset Name Eng 1";
            ...
            Session[PageFunction + "_ERROR_07"] = "Please select Asset Type";
            //================ TABLE ==================================================
            Session["HeaderText"] = PageName;
            ...
            Session[PageFunction + "_Column02"] = "Asset Name Thai 1";
            Session[PageFunction + "_Column03"] = "Asset Name Eng 1";
            Session[PageFunction + "_Column04"] = "Start Date";
            Session[PageFunction + "_Column05"] = "End Date";
            Session[PageFunction + "_Column06"] = "Asset Type";

            Session[PageFunction + "_Column07"] = "Asset Name Thai 2";
            Session[PageFunction + "_Column08"] = "Asset Name Eng 2";
            Session[PageFunction + "_Column09"] = "Unit";
            Session[PageFunction + "_Column10"] = "Asset Ref No";
        }
    }
}