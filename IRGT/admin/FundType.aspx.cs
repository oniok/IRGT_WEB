...
public partial class admin_FundType : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (LANG == cCommon.Language_Thai)
        {
            ...
            Session[PageFunction + "_ERROR_02"] = "โปรดระบุ ชื่อ" + PageName + "(ไทย)";
            Session[PageFunction + "_ERROR_03"] = "โปรดระบุ ชื่อ" + PageName + "(อังกฤษ)";
        ...
        else
        {
            ...
            Session[PageFunction + "_ERROR_02"] = "Please specify " + PageName + "Name(thai)";
            Session[PageFunction + "_ERROR_03"] = "Please specify " + PageName + "Name(eng)";
