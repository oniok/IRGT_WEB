<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="FundType.aspx.cs" Inherits="admin_FundType" %>
                        ...
                        <div class="row">
									<div class="col-xs-12">
                                        ...
                                        <center>
                                            <table>
                                                <tr>
                                                    <td><%=Session["fund_type_Column01"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Fund_Type_ID" style="width:100px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td><%=Session["fund_type_Column02"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Fund_Type_Name_T" style="width:150px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td><%=Session["fund_type_Column03"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Fund_Type_Name_E" style="width:150px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td>         
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
														        <th class="center" style="width:50px"><%=Session["fund_type_ColumnSEQ"]%></th>
														        <th class="center" style="width:100px"><%=Session["fund_type_Column01"]%></th>
														        <th class="center"><%=Session["fund_type_Column02"]%></th>
                                                                <th class="center"><%=Session["fund_type_Column03"]%></th>
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["fund_type_Column04"]%>
                                                                </th>
                                                                <th class="center" style="width:100px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["fund_type_Column05"]%>
                                                                </th>														      
														       <td class="center" style="width:80px"><%=Session["fund_type_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
													        <tr ng-repeat="x in Data">
														        <td class="center">{{ x.RowID }}</td>
                                                                <td>{{ x.Fund_Type_ID }}</td>
														        <td>{{ x.Fund_Type_Name_T }}</td>
                                                                <td>{{ x.Fund_Type_Name_E }}</td>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_fund_type"]%>', "../admin_popup/pop_FundType.aspx", null, "450");
        }
        $scope.fnEdit = function (KeyID) {
            fnOpenPopup('<%=Session["pop_edit_fund_type"]%>', "../admin_popup/pop_FundType.aspx?KeyID=" + KeyID, null, "450");
        }
        $scope.fnDelete = function (KeyID) {
            tmpKeyID = KeyID;
            fnConfirmMessage('<%=Session["pop_confirm_fund_type"]%>', '<%=Session["pop_delete_fund_type"]%>', fnDeleteYes);
        }       
    ...
    function GetPaging($scope, $http) {
        ...
        var Fund_Type_ID = document.getElementById('Fund_Type_ID').value;
        var Fund_Type_Name_T = document.getElementById('Fund_Type_Name_T').value;
        var Fund_Type_Name_E = document.getElementById('Fund_Type_Name_E').value;
