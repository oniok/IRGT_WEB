...
public partial class admin_WorkCenter : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (LANG == cCommon.Language_Thai)
        {
            ...
            Session[PageFunction + "_Column06"] = "ที่อยู่(ไทย)";
            Session[PageFunction + "_Column07"] = "ที่อยู่(อังกฤษ)";
            Session[PageFunction + "_Column08"] = "เบอร์ติดต่อ";
            Session[PageFunction + "_Column09"] = "ระดับหน่วยงาน";
        }
        else
        {
            //================ POPUP ==================================================
            string PageName = "Work Center";
            ...
            Session[PageFunction + "_Column06"] = "Address(thai)";
            Session[PageFunction + "_Column07"] = "Address(eng)";
            Session[PageFunction + "_Column08"] = "Tel.";
            Session[PageFunction + "_Column09"] = "Level Work";
        }
    }
}