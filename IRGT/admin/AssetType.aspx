<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="AssetType.aspx.cs" Inherits="admin_AssetType" %>
                        ...
                        <div class="row">
									<div class="col-xs-12">
                                        ...
                                        <center>
                                            <table>
                                                <tr>
                                                    <td><%=Session["asset_type_Column01"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="AssetTypeID" style="width:100px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td><%=Session["asset_type_Column02"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="AssetTypeTh" style="width:150px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td><%=Session["asset_type_Column03"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="AssetTypeEn" style="width:150px"/></td>
                                                    <td style="width:5px"></td>
                                                    <td>         
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
														        <th class="center" style="width:50px"><%=Session["asset_type_ColumnSEQ"]%></th>
														        <th class="center" style="width:100px"><%=Session["asset_type_Column01"]%></th>
														        <th class="center"><%=Session["asset_type_Column02"]%></th>
                                                                <th class="center"><%=Session["asset_type_Column03"]%></th>
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["asset_type_Column04"]%>
                                                                </th>
                                                                <th class="center" style="width:100px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["asset_type_Column05"]%>
                                                                </th>														      
														       <td class="center" style="width:80px"><%=Session["asset_type_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
													        <tr ng-repeat="x in Data">
														        <td class="center">{{ x.RowID }}</td>
                                                                <td>{{ x.Asset_Type_ID }}</td>
														        <td>{{ x.Asset_Type_Name_T }}</td>
                                                                <td>{{ x.Asset_Type_Name_E }}</td>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_asset_type"]%>', "../admin_popup/pop_AssetType.aspx", null, "450");
        }
        $scope.fnEdit = function (KeyID) {
            fnOpenPopup('<%=Session["pop_edit_asset_type"]%>', "../admin_popup/pop_AssetType.aspx?KeyID=" + KeyID, null, "450");
        }
        $scope.fnDelete = function (KeyID) {
            tmpKeyID = KeyID;
            fnConfirmMessage('<%=Session["pop_confirm_asset_type"]%>', '<%=Session["pop_delete_asset_type"]%>', fnDeleteYes);
        }        
