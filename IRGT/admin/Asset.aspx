<%@ Page Title="" Language="C#" MasterPageFile="~/master_page/main.master" AutoEventWireup="true" CodeFile="Asset.aspx.cs" Inherits="admin_Asset" %>
                                        ...
                                        <center>
                                            <table>
                                                <tr>                                                    
                                                    ...
                                                    <td><%=Session["asset_Column01"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Asset_ID" style="width:200px"/></td>                                                    
                                                    <td style="width:5px"></td>                                                   
                                                    <td><%=Session["asset_Column06"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Asset_Name_T" style="width:200px"/></td> 
                                                    <td style="width:5px"></td>  
                                                    <td><%=Session["asset_Column03"]%></td>
                                                    <td style="width:5px"></td>
                                                    <td><input type="text" id="Asset_Name_E" style="width:200px"/></td>  
                                                    <td style="width:5px"></td>
                                                </tr>
                                            </table>
                                        </center>
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
											        ...
											        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
												        <thead>
													        <tr>
														        <th class="center" style="width:50px"><%=Session["asset_ColumnSEQ"]%></th>
														        <th class="center"><%=Session["asset_Column01"]%></th>
														        <th class="center"><%=Session["asset_Column02"]%></th>
                                                                <th class="center"><%=Session["asset_Column03"]%></th>
                                                                <th class="center"><%=Session["asset_Column04"]%></th>
                                                                <th class="center" style="width:120px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["asset_Column04"]%>
                                                                </th>
                                                                <th class="center" style="width:100px">
                                                                    <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                                                    <%=Session["asset_Column05"]%>
                                                                </th>														      
														       <td class="center" style="width:80px"><%=Session["asset_ColumnEdit"]%></td>
													        </tr>
												        </thead>
                                                        <tbody>
													        <tr ng-repeat="x in Data">
                                                                ...
                                                                <td>{{ x.Asset_ID }}</td>
														        <td>{{ x.Asset_Name1_T }}</td>
                                                                <td>{{ x.Asset_Name1_E }}</td>
...
<script>
    ...
    function fnMain($scope, $http) {
        ...
        $scope.fnNew = function () {
            fnOpenPopup('<%=Session["pop_add_asset"]%>', "../admin_popup/pop_Asset.aspx", null, "450");
        }
        $scope.fnEdit = function (KeyID) {
            fnOpenPopup('<%=Session["pop_edit_asset"]%>', "../admin_popup/pop_Asset.aspx?KeyID=" + KeyID, null, "450");
        }
        $scope.fnDelete = function (KeyID) {
            tmpKeyID = KeyID;
            fnConfirmMessage('<%=Session["pop_confirm_asset"]%>', '<%=Session["pop_delete_asset"]%>', fnDeleteYes);
        }
    ...
    function GetPaging($scope, $http) {
        ...
        var Asset_Name_T = document.getElementById('Asset_Name_T').value;
        var Asset_Name_E = document.getElementById('Asset_Name_E').value;
        ...
        var data = $.param({
            ...
            PageSize: PageSize,
            Asset_ID: Asset_ID,
            Asset_Name_T: Asset_Name_T,
            Asset_Name_E: Asset_Name_E,
