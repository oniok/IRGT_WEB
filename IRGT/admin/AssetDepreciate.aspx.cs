...
public partial class admin_AssetDepreciate : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string PageFunction = "asset_depreciate";
        ...
        {
            //================ POPUP ==================================================
            string PageName = "ค่าเสื่อมครุภัณฑ์";
            ...
            //================ POPUP ERROR ===========================================
            Session[PageFunction + "_ERROR_01"] = "โปรดเลือก ครุภัณฑ์";
            ...
            Session[PageFunction + "_Column01"] = "รหัสครุภัณฑ์";
            Session[PageFunction + "_Column02"] = "ชื่อครุภัณฑ์";
            Session[PageFunction + "_Column03"] = "อัตราคำนวนค่าเสื่อมรายปี";
            Session[PageFunction + "_Column06"] = "ราคากลางต่อหน่วย";
            Session[PageFunction + "_Column07"] = "อายุการใช้งาน";
