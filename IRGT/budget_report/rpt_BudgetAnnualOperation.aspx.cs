...
public partial class rpt_BudgetAnnualOperation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string PageName = "รายงานประจำปีงบดำเนินการ";
    ...
    {
        IRGT_Service.Budget_Operation IRGTService = new IRGT_Service.Budget_Operation();
        DataTable dtTemp = IRGTService.getMasterData("BudgetOperationType", "TH", "");
    ...
    public void fnSearch()
    {
        ...
        try
        {
            ...
            String sel_command = "EXEC [dbo].[sp_getBudget_Annual_Operation] @Loc_ID = N'" + ddlLoc.SelectedValue
