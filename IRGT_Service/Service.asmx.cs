...
namespace IRGT_Service
{
    ...
    public class Service : System.Web.Services.WebService
    {
        ...
        #region Master Data
        [WebMethod]
        public DataTable getMasterData(string FN, string Lang)
        {
        ...
        [WebMethod]
        public DataTable getAsset_Depreciate(int PageSize, int PageIndex, string Asset_ID, string Lang)
        {
            string StoreProcedureName = "sp_getAsset_Depreciate";
            SetLog("========================START==============================");
            SetLog("[@Time][Store:" + StoreProcedureName + "]");
        ...
        {
            string StoreProcedureName = "sp_getAsset_Depreciate_Count";
            SetLog("========================START==============================");
            SetLog("[@Time][Store:" + StoreProcedureName + "]");
            SqlConnection DBConnect = GetDBConnection();
            SqlCommand DBCommand = new SqlCommand();
        ...
        public bool checkAsset_Depreciate(int KeyID, string Asset_ID, out string ReturnMSG_TH, out string ReturnMSG_EN)
        {
            ...
            string StoreProcedureName = "sp_checkAsset_Depreciate";
            SetLog("========================START==============================");
            SetLog("[@Time][Store:" + StoreProcedureName + "]");
            SqlConnection DBConnect = GetDBConnection();
            SqlCommand DBCommand = new SqlCommand();
        ...
        [WebMethod]
        public bool setAsset_Depreciate(int KeyID, string Asset_ID, string Depreciate_Rate, string Standard_Price, string Term_Use
            , string Start_Date, string End_Date, string UserCode
            , out string ReturnMSG_TH, out string ReturnMSG_EN)
        {
            bool ReturnOutput = false;
            ...
            string StoreProcedureName = "sp_setAsset_Depreciate";
            SetLog("========================START==============================");
            SetLog("[@Time][Store:" + StoreProcedureName + "]");
            SqlConnection DBConnect = GetDBConnection();
            SqlCommand DBCommand = new SqlCommand();
